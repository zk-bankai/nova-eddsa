...
mod test {
    ...
    fn test_key() {
        ...
        for _ in 0..20 {
            ...
            let wrong_key_scalar = BigUint::from_bytes_le(wrong_key_scalar_bytes.as_ref()).rem(q.clone());
    ...
    fn test_sign_r() {
        ...
        for _ in 0..20 {
            ...
            let wrong_r_scalar = BigUint::from_bytes_le(wrong_r_scalar_bytes.as_ref()).rem(q.clone());
